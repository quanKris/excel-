...
# import xlrd
# # 读取第一个 Excel 文件
# excel1 = pd.read_excel("C:\\Users\\MDPI\\Desktop\\脚本\\aaa.xls")

# # 读取第二个 Excel 文件 
# excel2 = pd.read_excel("C:\\Users\\MDPI\\Desktop\\脚本\\bbb.xls")
# # 读取第二个 Excel 文件
# file_path = 'C:\\Users\\MDPI\\Desktop\\脚本\\bbb.xls'
# workbook = xlrd.open_workbook(file_path)
# sheet = workbook.sheet_by_index(0)  # 假设数据在第一个 sheet 中


# # 打开模板文件
# template_file_path = 'C:\\Users\\MDPI\\Desktop\\脚本\\aaa.xls'

# # 循环处理每一行数据
# for row_index in range(2, sheet.nrows):  # 从第三行开始到最后一行
...
#     # 打开模板文件
#     template_wb = xlrd.open_workbook(template_file_path)
#     template_ws = template_wb.sheet_by_index(0)  # 假设模板数据在第一个 sheet 中
    
#     # 复制模板文件到新的 Excel 文件中
#     for i in range(template_ws.nrows):
#         for j in range(template_ws.ncols):
#             cell_value = template_ws.cell_value(i, j)
...
#     new_file_name = f'{value_2}.xls'  # 使用第二个值作为文件名
...
import copy
# 读取第一个 Excel 文件
excel1 = pd.read_excel("C:\\Users\\MDPI\\Desktop\\脚本\\ccc.xlsx")

# 读取第二个 Excel 文件 
excel2 = pd.read_excel("C:\\Users\\MDPI\\Desktop\\脚本\\ddd.xlsx")
